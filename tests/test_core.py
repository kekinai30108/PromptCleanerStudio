...
class CoreTests(unittest.TestCase):
    def test_dedup(self):
        self.assertEqual(clean('cat, CAT, blue_eyes, blue eyes, 2026, 42').output, 'cat, blue_eyes, 2026, 42')
    ...
    def test_filters(self):
        self.assertEqual(clean('貓cat!?, blue eyes 1.2k, 2026, cat', Rules(remove_chinese=True, remove_excl=True, tag_counts=True)).output, 'cat, blue eyes, 2026')
